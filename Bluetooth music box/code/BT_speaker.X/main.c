 ...
 * Author: robbe
 *
 * Created on 16 maart 2021, 10:17
 */

#include <xc.h>
#include <stdio.h>
#include "P18_SPI.h" //-> already in ILI9341 header
#include "ILI9341_SPI.h"
#include "xpt2046_SPI.h"

#define _XTAL_FREQ 64000000 //interne klok van 64MHZ
...
// CONFIG2H
#pragma config BORV = VBOR_245      // Brown Out Reset Voltage selection bits->Brown-out Reset Voltage (VBOR) set to 2.85V
...
unsigned char PosTouchX(void);
unsigned char PosTouchY(void);
